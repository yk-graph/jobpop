...
import { Card, CardContent, CustomCardHeader, ThumbnailWithNameCard } from '@jobpop/ui'
  ...
  return (
    <section id="members">
      <Card className="border-none">
        <CustomCardHeader title="Members" titleSize="lg" description={`Total Members: ${employees.length}`} />
        <CardContent>
