...
export function GoogleMapAdvancedMarker({
  ...
  return (
    <AdvancedMarker
      ...
      className={cn(
        'relative cursor-pointer -translate-y-1.5 transition-all duration-200 ease-in-out z-10',
        hovered && 'z-20 -translate-y-2',
        clicked && 'z-30 -translate-y-2'
      )}
    >
      <div
        className={cn(
          ...
          clicked && 'z-40 rounded-none w-fit min-w-auto max-w-lg h-80'
        )}
      >
        {/* ピンのUI */}
        <div
